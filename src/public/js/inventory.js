...
function buyList() {
    ...
    `<form action="/buy" method="POST">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="address" id="address" aria-describedby="endereco" placeholder="Ex. Rua jose pereira de assis, 445" required>
        </div>
        <br>
        <div class="form-group">
          <label for="quantidade">Quantidade</label>
          <input type="number" class="form-control" name="quantity" id="quantity" placeholder="Ex. 4" required>
        </div>
        <br>
